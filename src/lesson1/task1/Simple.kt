...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double =
    ((vershoks + (arshins + (sagenes * 3)) * 16) * 4.445) / 100
...
//Ура! Научился возводить число в степень...Но не факт.
 ...
 */
fun numberRevert(number: Int): Int = number / 100 + 10 * (number / 10 % 10) + 100 * (number % 10)
